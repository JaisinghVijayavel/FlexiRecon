...
DROP function IF EXISTS `fn_get_con_castexpression` $$
CREATE function `fn_get_con_castexpression`
(
  ...
  repeat
    if v_split_col <> '' then
      ...
      if n > 0 then
        ...
        set v_field_name = fn_get_con_fieldcast(in_pipeline_code,in_dataset_code,v_split_col);
