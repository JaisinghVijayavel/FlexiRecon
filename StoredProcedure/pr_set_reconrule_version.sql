  ...
  */
  ...
  (
	...
	update recon_mst_trecon set
		...
		update_date = sysdate()
	where recon_code = in_recon_code and active_status = 'Y' and delete_flag = 'N' ;
...
--  rule --
		...
		where a.recon_code = in_recon_code and active_status = 'Y' and a.delete_flag = 'N';
		
		insert into recon_mst_trulehistory
		(
		...
		where recon_code = in_recon_code
		and recon_version = in_reconrule_version and active_status='Y' and delete_flag = 'N';

		insert into recon_mst_truleconditionhistory
		(
		...
		SELECT
			...
			comparison_field,comparison_criteria,comparison_filter,open_parentheses_flag,close_parentheses_flag,join_condition,
		...
		and recon_version = in_reconrule_version and delete_flag = 'N';
  
		insert into recon_mst_trulegrpfieldhistory
		(
		...
		insert into recon_mst_trulerecorderhistory
		(
			rule_code,recorder_applied_on,recorder_seqno,recorder_field,recon_version,active_status,insert_date,insert_by
		)
		select 
		...
		insert into recon_mst_truleselefilterhistory
		(	
			...
			open_parentheses_flag,close_parentheses_flag,join_condition,recon_version,active_status,insert_date,insert_by
		)
		select 
			rule_code,ruleselefilter_seqno,filter_applied_on,filter_field,filter_criteria,add_filter,
			ident_criteria,ident_value_flag,ident_value,
			open_parentheses_flag,close_parentheses_flag,join_condition,recon_version,active_status,sysdate(),in_user_code
		...
		insert into recon_mst_truleaggconditionhistory
		(
		...
		select 
			rule_code,ruleaggcondition_seqno,ruleagg_applied_on,ruleagg_field,ruleagg_criteria,ruleagg_value_flag,ruleagg_value,
			open_parentheses_flag,close_parentheses_flag,join_condition,recon_version,active_status,sysdate(),in_user_code
		...
		insert into recon_mst_truleaggfieldhistory
		(
...
-- theme --
		update recon_mst_ttheme set
			...
			update_by = in_user_code,
			update_date = sysdate()
		where recon_code = in_recon_code and delete_flag = 'N' and active_status = 'Y';
		...
		where a.recon_code = in_recon_code and a.active_status ='Y' and a.delete_flag = 'N';
		
		insert into recon_mst_tthemehistory
		(
		...
		insert into recon_mst_tthemeconditionhistory
		(
		...
		insert into recon_mst_tthemefilterhistory
		(
		...
		insert into recon_mst_tthemegrpfieldhistory
		(
		...
		insert into recon_mst_tthemeaggfieldhistory
		(
		...
		insert into recon_mst_tthemeaggconditionhistory
		(
...
-- preprocess --	
		...
		update recon_mst_tpreprocessexp set
			recon_version = in_reconrule_version,
			update_by = in_user_code,
			update_date = sysdate()
		where preprocess_code in
        ...
        update recon_mst_tpreprocessdsupdate set
			recon_version = in_reconrule_version,
			update_by = in_user_code,
			update_date = sysdate()
		where preprocess_code in
		...
		insert into recon_mst_tpreprocesshistory
		(
			preprocess_code,preprocess_desc,recon_code,get_recon_field,set_recon_field,process_method,process_query,
			process_expression,process_function,lookup_dataset_code,lookup_multi_return_flag,lookup_return_field,
			lookup_group_flag,postprocess_flag,preprocess_order,hold_flag,recon_version,active_status,insert_date,insert_by,
			cumulative_flag, opening_flag,group_flag,agg_flag,lookup_agg_return_function,
			source_dataset_code, comparison_dataset_code,recorderby_type,applytoall_tranbrkp_flag
		)
		select
			preprocess_code,preprocess_desc,recon_code,get_recon_field,set_recon_field,process_method,process_query,
			process_expression,process_function,lookup_dataset_code,lookup_multi_return_flag,lookup_return_field,
			lookup_group_flag,postprocess_flag,preprocess_order,hold_flag,recon_version,active_status,sysdate(),in_user_code,
			cumulative_flag, opening_flag,group_flag,agg_flag,lookup_agg_return_function,
      source_dataset_code, comparison_dataset_code,recorderby_type,applytoall_tranbrkp_flag
		...
		insert into recon_mst_tpreprocessconditionhistory
		(
			preprocess_code,condition_seqno,source_field_type,source_field,comparison_field,recon_field,extraction_criteria,extraction_filter,lookup_field,
			comparison_criteria,comparison_filter,open_parentheses_flag,close_parentheses_flag,join_condition,
			recon_version,active_status,insert_date,insert_by
		)
		select
		...
		insert into recon_mst_tpreprocessfilterhistory
		(
			preprocess_code,filter_seqno,filter_applied_on,filter_field,filter_criteria,filter_value_flag,filter_value,
			open_parentheses_flag,close_parentheses_flag,join_condition,recon_version,active_status,insert_date,insert_by
		)
		select
			preprocess_code,filter_seqno,filter_applied_on,filter_field,filter_criteria,filter_value_flag,filter_value,
		...
		insert into recon_mst_tpreprocesslookuphistory
		(
			preprocess_code,lookup_seqno,lookup_return_field,set_recon_field,reverse_update_flag,value_flag,
			recon_version,active_status,insert_date,insert_by
		)
		SELECT
			preprocess_code,lookup_seqno,lookup_return_field,set_recon_field,reverse_update_flag,value_flag,
		...
		insert into recon_mst_tpreprocessrecorderhistory 
		(
			preprocess_code,recorder_on,recorder_seqno,recorder_field,
			recon_version,active_status,insert_date,insert_by
		)
		SELECT 
			preprocess_code,recorder_on,recorder_seqno,recorder_field,recon_version,active_status,sysdate(),in_user_code
		...
		insert into recon_mst_tpreprocessgrpfieldhistory
		(
			preprocess_code,grpfield_on,grpfield_seqno,grp_field,recon_version,active_status,insert_date,insert_by
		)
		SELECT
			preprocess_code,grpfield_on,grpfield_seqno,grp_field,recon_version,active_status,sysdate(),in_user_code
		...
		INSERT INTO recon_mst_tpreprocessexphistory
		(
			preprocess_code,preprocessexp_on,preprocessexp_sno,preprocessexp_update_field,preprocess_expression,
			preprocess_function,recon_version,active_status,insert_date,insert_by
		)
		SELECT
			preprocess_code,preprocessexp_on,preprocessexp_sno,preprocessexp_update_field,preprocess_expression,
			preprocess_function,recon_version,active_status,sysdate(),in_user_code
		from recon_mst_tpreprocessexp
		where preprocess_code in  
		(
			select preprocess_code from recon_mst_tpreprocess 
			where recon_code = in_recon_code and active_status='Y' and delete_flag = 'N'
        ...
        INSERT INTO recon_mst_tpreprocessdsupdatehistory
		(
			 preprocess_code,rec_seqno,source_field,comparison_field,reverse_update_flag,value_flag,recon_version, active_status,
			 insert_date,insert_by
		)
		SELECT
			preprocess_code,rec_seqno,source_field,comparison_field,reverse_update_flag,value_flag,recon_version,active_status,
			sysdate(),in_user_code			
		from recon_mst_tpreprocessdsupdate
		where preprocess_code in  
		(
			select preprocess_code from recon_mst_tpreprocess 
			where recon_code = in_recon_code and active_status='Y' and delete_flag = 'N'
