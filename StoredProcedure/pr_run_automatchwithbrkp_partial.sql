...
DROP PROCEDURE IF EXISTS `pr_run_automatchwithbrkp_partial` $$
CREATE PROCEDURE `pr_run_automatchwithbrkp_partial`(
      ...
      set v_comparison_headbrkp_sql = concat(v_comparison_headbrkp_sql,' and excp_value > 0 and tran_gid > 0 ');
          ...
          rule_block:begin
            ...
            rule_loop: loop
              ...
              set v_rule_condition = concat(v_rule_condition,
                                            v_build_condition,' ');
