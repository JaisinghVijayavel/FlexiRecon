...
BEGIN
  select
    rule_gid,rule_code,rule_name,a.recon_code,a.recon_name,source_dataset_code,a.recon_rule_version,
    c.dataset_name as source_dataset_desc,
    comparison_dataset_code,d.dataset_name as comparison_dataset_desc,a.recon_rule_version,system_match_flag,
    case system_match_flag when 'Y' then 'YES' else 'NO' end as system_match_flag_desc,
    hold_flag,
