  ...
  declare v_reporttemplate_code_es text;
    ...
    update recon_trn_tjob set 
		...
		if @report_exec_type_code = "R" then
			...
			select 
				r.report_code,t.reporttemplate_code,r.report_exec_type,sp_name,r.table_name,r.rpt_table_name
			into 
      ...
      call pr_get_reconstaticvaluesql(v_sql,in_archival_code,in_recon_code,in_condition,in_user_code,
			...
			set @sp_sql = ifnull(@sp_sql,'');
			
			prepare mulltisp_stmt from @sp_sql;
